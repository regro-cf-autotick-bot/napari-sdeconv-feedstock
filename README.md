...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-sdeconv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15412&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-sdeconv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-sdeconv` can be installed with:

```
conda install napari-sdeconv
```

It is possible to list all of the versions of `napari-sdeconv` available on your platform with:
